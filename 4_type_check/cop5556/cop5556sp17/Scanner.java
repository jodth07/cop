...
public class Scanner {
	...
	public enum Kind {
		...
		KW_SCALE("scale"), 						EOF("eof"); // End of file token
	...
	public Scanner scan() throws IllegalCharException, IllegalNumberException {
		int pos = 0,  curPos = 0; // TODO implement startPos
		//TODO startPos is to keep track of beginning of every token.
